...
@inline function Base.hasproperty(::GeometricData{DataType, SystemType, TupleType},
        s::Symbol) where {DataType, SystemType, TupleType}
    hasfield(TupleType, s) || hasfield(GeometricData, s)
end

@inline function Base.getproperty(d::GeometricData{DataType, SystemType, TupleType},
        s::Symbol) where {DataType, SystemType, TupleType}
